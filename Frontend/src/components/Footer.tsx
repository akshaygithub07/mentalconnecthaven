      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-between">
          <div>
            <Link
              to="/"
              className="text-2xl font-semibold text-mind-700 mb-6 inline-block"
            >
              MindConnect
            </Link>
            <p className="text-calm-600 mb-6">
              Your complete mental health platform for therapy sessions and
          ...
          {/* <div>
            <h3 className="text-lg font-semibold text-calm-900 mb-6">
              Quick Links
            </h3>
            <ul className="space-y-4">
              <li>
                <Link
                  to="/therapists"
                  className="text-calm-600 hover:text-mind-600 transition-colors duration-300"
                >
                  Find a Therapist
                </Link>
              </li>
        ...
        <div className="border-t border-calm-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a
                href="#"
                className="text-calm-600 hover:text-mind-600 text-sm transition-colors duration-300"
              >
                Privacy Policy
              </a>
              <a
